...
#ifndef STUDYING_DATA_STRUCTURES_RECURSIONS_H
#define STUDYING_DATA_STRUCTURES_RECURSIONS_H

void add_till_ascending_time(int val, int target);
void add_till_descending_time(int val, int target);
